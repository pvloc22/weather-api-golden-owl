...
class EmailSubscriptionRepository {
  ...
  Future<bool> verifyOtp(String email, String otp) async {
    try {
      ...
      // For demonstration purposes - log the stored and entered values
      // debugPrint('Stored Email: $storedEmail, Entered Email: $email');
      // debugPrint('Stored OTP: $storedOtp, Entered OTP: $otp');
