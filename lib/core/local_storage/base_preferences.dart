...
class BasePreferences {
  ...
  Future<bool> appendForecastToCache({
    ...
    // Bước quan trọng: Sử dụng dữ liệu dự báo mới từ API và thay thế hoàn toàn dữ liệu trong cache
    // Dữ liệu mới từ API đã bao gồm cả dự báo cũ và mới, nên không cần gộp
    ...
    // Ghi đè lại cache với danh sách dự báo mới từ API
    final updatedJson = jsonEncode({
      'timestamp': map['timestamp'], // giữ nguyên timestamp cũ
